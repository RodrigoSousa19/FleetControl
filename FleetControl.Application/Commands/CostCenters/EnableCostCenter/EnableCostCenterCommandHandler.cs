...
{
    public class EnableCostCenterCommandHandler : IRequestHandler<EnableCostCenterCommand, ResultViewModel>
    {
        private readonly IGenericRepository<CostCenter> _repository;
        public EnableCostCenterCommandHandler(IGenericRepository<CostCenter> repository)
        {
