...
{
    public class DisableCostCenterCommandHandler : IRequestHandler<DisableCostCenterCommand, ResultViewModel>
    {
        private readonly IGenericRepository<CostCenter> _repository;
        public DisableCostCenterCommandHandler(IGenericRepository<CostCenter> repository)
        {
