...
{
    public class CancelReservationCommandHandler : IRequestHandler<CancelReservationCommand, ResultViewModel>
    {

        private readonly IGenericRepository<Reservation> _repository;

        public CancelReservationCommandHandler(IGenericRepository<Reservation> repository)
        {
