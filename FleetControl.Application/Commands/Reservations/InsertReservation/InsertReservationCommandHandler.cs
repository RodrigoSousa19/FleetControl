...
{
    public class InsertReservationCommandHandler : IRequestHandler<InsertReservationCommand, ResultViewModel<Reservation>>
    {
        private readonly IGenericRepository<Reservation> _repository;

        public InsertReservationCommandHandler(IGenericRepository<Reservation> repository)
        {
