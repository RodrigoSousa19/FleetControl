...
{
    public class FinishReservationCommandHandler : IRequestHandler<FinishReservationCommand, ResultViewModel>
    {

        private readonly IGenericRepository<Reservation> _repository;

        public FinishReservationCommandHandler(IGenericRepository<Reservation> repository)
        {
