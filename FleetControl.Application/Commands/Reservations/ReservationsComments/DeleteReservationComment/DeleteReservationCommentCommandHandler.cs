...
{
    public class DeleteReservationCommentCommandHandler : IRequestHandler<DeleteReservationCommentCommand, ResultViewModel>
    {
        private readonly IGenericRepository<ReservationComment> _repository;

        public DeleteReservationCommentCommandHandler(IGenericRepository<ReservationComment> repository)
        {
