...
{
    public class InsertReservationCommandHandler : IRequestHandler<InsertReservationCommand, ResultViewModel>
    {

        private readonly IGenericRepository<ReservationComment> _repository;

        public InsertReservationCommandHandler(IGenericRepository<ReservationComment> repository)
        {
