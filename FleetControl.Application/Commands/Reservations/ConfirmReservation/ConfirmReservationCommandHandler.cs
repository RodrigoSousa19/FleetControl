...
{
    public class ConfirmReservationCommandHandler : IRequestHandler<ConfirmReservationCommand, ResultViewModel>
    {
        private readonly IGenericRepository<Reservation> _repository;

        public ConfirmReservationCommandHandler(IGenericRepository<Reservation> repository)
        {
