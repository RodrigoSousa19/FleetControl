...
{
    public class InserUserCommandHandler : IRequestHandler<InsertUserCommand, ResultViewModel<User>>
    {

        private readonly IGenericRepository<User> _repository;

        public InserUserCommandHandler(IGenericRepository<User> repository)
        {
