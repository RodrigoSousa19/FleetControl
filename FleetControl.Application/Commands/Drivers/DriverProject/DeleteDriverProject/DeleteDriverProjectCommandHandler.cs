...
{
    public class DeleteDriverProjectCommandHandler : IRequestHandler<DeleteDriverProjectCommand, ResultViewModel>
    {
        private readonly IGenericRepository<DriverProjects> _repository;

        public DeleteDriverProjectCommandHandler(IGenericRepository<DriverProjects> repository)
        {
