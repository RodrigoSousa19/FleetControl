        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Projects_CostCenters_IdCostCenter",
                        column: x => x.IdCostCenter,
                        principalTable: "CostCenters",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Projects_Customers_IdCustomer",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Vehicles_Projects_IdProject",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DriverProjects", x => new { x.IdDriver, x.IdProject });
                    table.ForeignKey(
                        name: "FK_DriverProjects_Drivers_IdDriver",
                        column: x => x.IdDriver,
                        principalTable: "Drivers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_DriverProjects_Projects_IdProject",
                        column: x => x.IdProject,
                        principalTable: "Projects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Reservations_Drivers_IdDriver",
                        column: x => x.IdDriver,
                        principalTable: "Drivers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Reservations_Vehicles_IdVehicle",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_VehicleMaintenance_Vehicles_IdVehicle",
                        column: x => x.IdVehicle,
                        principalTable: "Vehicles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ReservationComments_Reservations_IdReservation",
                        column: x => x.IdReservation,
                        principalTable: "Reservations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ReservationComments_Users_IdUser",
                        column: x => x.IdUser,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DriverProjects_IdProject",
                table: "DriverProjects",
                column: "IdProject");

            migrationBuilder.CreateIndex(
                name: "IX_Drivers_IdUser",
                table: "Drivers",
                column: "IdUser");

            migrationBuilder.CreateIndex(
                name: "IX_Projects_IdCostCenter",
                table: "Projects",
                column: "IdCostCenter");

            migrationBuilder.CreateIndex(
                name: "IX_Projects_IdCustomer",
                table: "Projects",
                column: "IdCustomer");

            migrationBuilder.CreateIndex(
                name: "IX_ReservationComments_IdReservation",
                table: "ReservationComments",
                column: "IdReservation");

            migrationBuilder.CreateIndex(
                name: "IX_ReservationComments_IdUser",
                table: "ReservationComments",
                column: "IdUser");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reservations_IdDriver",
                table: "Reservations",
                column: "IdDriver");

            migrationBuilder.CreateIndex(
                name: "IX_Reservations_IdVehicle",
                table: "Reservations",
                column: "IdVehicle");
